...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format(
            'postgres', 'donthack', 'localhost:5432', 'trivia_test')
    ...
    def test_get_categories_with_successful_response(self):
        """
        Test getting all categories with a successful response
        """
    ...
    def test_get_questions_with_successful_response(self):
        """
        Test getting all questions with a successful response
        """
    ...
    def test_get_questions_with_failing_response(self):
        """
        Test to get unavailable questions from the database
        """
    ...
    def test_delete_a_questions_with_successful_response(self):
        """
        Test delete existing question from the database
        """
    ...
    def test_get_questions_of_given_category_with_successful_response(self):
        """
        Test fetching all questions of a given category id
        """
    ...
    def test_get_questions_of_given_category_with_failing_response(self):
        """
        Test fetching all questions of an unexisting category.
        """
        category_id = Category.query.first().id
        response = self.client(
            ).get(f"/categories/{category_id + 1}/questions")
        data = json.loads(response.data)
        self.assertTrue(response.status_code, 404)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Resource not found.')
    ...
    def test_create_a_question_with_success_response(self):
        """
        Test creating a question with all required
        fields and required request method
        """
